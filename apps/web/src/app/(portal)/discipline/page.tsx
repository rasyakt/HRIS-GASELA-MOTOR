        ...
        <CardContent className="p-4 space-y-4">
          ...
          {warningsQuery.isLoading ? (
              ...
              <table className="w-full text-xs text-left">
                ...
                <tbody className="divide-y divide-zinc-200 text-zinc-900">
                  {warningsQuery.data.items.map((sp) => {
                    ...
                    return (
                      <tr key={sp.id} className="hover:bg-zinc-50/80 transition-colors">
                        ...
                        <td className="p-3">
                          ...
                          <div className="text-[10px] text-zinc-500 font-mono">NIK: {sp.employee.employeeNumber}</div>
                        </td>
                        <td className="p-3 text-zinc-600">
                          <div>{sp.employee.department?.name || '—'}</div>
                          <div className="text-[10px] text-zinc-400">{sp.employee.position?.name || '—'}</div>
                        </td>
                        ...
                        <td className="p-3">
                          ...
                          {isExpired ? (
                            <span className="text-[10px] text-zinc-400">Status: Selesai</span>
                          ) : (
                            <span className="text-[10px] text-red-600 font-semibold">Status: Aktif</span>
                          )}
                        </td>
            ...
            <div className="rounded-xl border border-dashed border-zinc-200 p-12 text-center">
              ...
              <p className="text-sm font-semibold text-zinc-800">Tidak ada Surat Peringatan (SP) yang tercatat</p>
              <p className="text-xs text-zinc-500 mt-1">Semua karyawan berdisiplin tinggi atau sesuai dengan kata kunci pencarian.</p>
            </div>
          )}
        </CardContent>
      </Card>
