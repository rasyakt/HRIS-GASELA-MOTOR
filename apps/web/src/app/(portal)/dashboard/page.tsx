  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 gap-3 lg:hidden">
        {rows.map((r) => (
          <div key={r.date} className="flex flex-col gap-2 rounded-lg border border-zinc-100 bg-zinc-50 p-3">
            <div className="flex items-center justify-between">
              <span className="font-semibold text-zinc-900 text-sm">{fmtDate(r.date)}</span>
