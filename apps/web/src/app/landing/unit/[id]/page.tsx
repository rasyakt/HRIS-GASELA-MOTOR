...
import { ArrowLeft, Phone, Mail, Facebook, Clock, ShieldCheck, MapPin } from 'lucide-react';
...
const UNIT_DETAILS: Record<string, UnitDetail> = {
  futsal: {
    ...
    location: 'JL. Raya Cikoneng - Ciamis Telp (0265) 777000',
    features: [
  ...
  motor: {
    ...
    phone: '(0265) 776103',
    location: 'JL. Raya Cikoneng - Ciamis Telp (0265) 776103',
    features: [
  ...
  sellular: {
    ...
    phone: '(0265) 2752592',
    location: 'JL. Raya Cikoneng-Ciamis Telp (0265) 2752592',
    features: [
  ...
  makaroni: {
    ...
    phone: '0265 2751184',
    location: 'Jl. Tentara Pelajar, Dsn Gunung Asih 1, Kec. Cikoneng – Ciamis, Jawa Barat',
    features: [
...
export default async function UnitDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-zinc-950 text-slate-900 dark:text-white relative py-24 px-6 md:px-16 lg:px-24 overflow-hidden">
      {/* Background patterns */}
